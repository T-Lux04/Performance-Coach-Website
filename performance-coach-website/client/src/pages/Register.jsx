    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-gray-300 mt-1">Create your account</p>
        </div>
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          {success && (
            <div className="text-sm text-green-400 bg-green-900/20 border border-green-500/30 rounded px-3 py-2">{success}</div>
          )}
          <div>
          ...
          <div>
            <label className="block text-sm mb-1 emph">Confirm Password</label>
            <input
              type="password"
              value={confirm}
          ...
          <p className="text-center text-sm text-gray-400">
            Already have an account? <a className="text-yellow-400 hover:underline" href="/login">Login</a>
          </p>
        </form>
      </motion.div>
    </div>
