    ...
    return(
        ...
        <section id="testimonials" className="bg-black py-20 px-10 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 justify-center">
                ...
                <motion.div key={index} className="p-6 bg-gray-900 border border-gold-500 shadow-lg rounded-xl" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
