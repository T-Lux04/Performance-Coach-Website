...
//   await fetch('https://performance-coach-website.onrender.com/api/contact', {
//     method: 'POST',
...
// };
  ...
  return (
    ...
    // </section>
    <div>
      <h1 className="font-bold mb-12">Get Quote</h1>
      <h4 className="text-xl font-bold mb-6 ">Email:</h4>
      <a className="text-xl emph" href="mailto:coach@phasetennis.co.uk">coach@phasetennis.co.uk</a>
    </div>
  )
}
